  ...
  return (
    <SafeAreaView style={styles.root} edges={["top", "bottom"]}>
      ...
      <ScrollView contentContainerStyle={{ padding: SPACING.lg, paddingBottom: 60 }}>
        ...
        <Text style={styles.footerText}>© 2026 Online Vaidhyaji · Made with 💚 in Bharat</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
